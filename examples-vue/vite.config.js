...
import framework from '@vitejs/plugin-vue'
...
export default defineConfig({
    resolve: {
        alias: [
            ...
            {
                find: '@',
                replacement: resolve(process.cwd(), 'node_modules/winduum-vue/src')
            }
        ]
    },
    ...
    build: {
        ...
        modulePreload: false,
        emptyOutDir: true,
        outDir: resolve(process.cwd(), '../docs/public/examples-vue')
    }
})
